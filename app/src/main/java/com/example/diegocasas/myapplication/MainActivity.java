...
import com.example.diegocasas.myapplication.R;
...
public class MainActivity extends AppCompatActivity {
        ...
        switch (requestCode) {
            ...
            case REQUEST_WRITE_STORAGE:
                if (canAccessWriteStorage()) {
                    ...
                    Toast.makeText(this, "La aplicación no tiene permitido escribir en tu almacenamiento. Por lo tanto, no puede funcionar correctamente. Por favor considera agregar el permiso", Toast.LENGTH_LONG).show();
                }
                break;
        }
    }
    ...
    public void sendViaBluetooth(View v) {
        ...
        if (btAdapter == null) {
            Toast.makeText(this, "Bluetooth no es soportado en este dispositivo", Toast.LENGTH_LONG).show();
        } else {
            enableBluetooth();
        }
    }
